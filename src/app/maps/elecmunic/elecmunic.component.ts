...
export class ElecmunicComponent implements OnInit {
  ...
  ngOnInit() {
    var divElement = document.getElementById('viz1557663676525');
     ...
     vizElement.style.height = '1027px'; } else if (divElement.offsetWidth > 500) { vizElement.style.width = '900px'; 
     vizElement.style.height = '1027px'; } else { vizElement.style.width = '100%'; vizElement.style.height = '1394px'; } 
